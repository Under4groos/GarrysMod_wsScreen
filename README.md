# wsScreen
```
Проект предназначен для управления техникой и прочим с телефона.
Для работы нам нужен Wiremod для игры GarrysMod, а так же доступ к Е2 ( если вы играете на сервере )
```
